...
// Bộ não walk-forward + kiểm định đã chuyển sang js/xsmn-brain.js (2 đường LÔ/ĐỀ,
// dàn chiến lược cạnh tranh, chỉnh Holm, kiểm định giữ lại). File này chỉ còn crawl/parse
// + thống kê mô tả.
